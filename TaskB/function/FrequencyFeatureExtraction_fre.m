function[frequency_mat_nonStimulus,frequency_mat_Stimulus]=FrequencyFeatureExtraction_fre(run_data,num_samples_trial,num_repetition,signal_length,candidate_channel,fre)
%%
...
%         frequency_selected=P_P3(fre_index);
        ...
        P_Stimulus_P3=[P_Stimulus_P3,frequency_selected];
    end
...
%         frequency_selected=P_P3(fre_index);
        frequency_selected=(P_P3(fre_index)+P_P3(fre_index+1))/2;
        P_nonStimulus_P3=[P_nonStimulus_P3,frequency_selected];
    end
